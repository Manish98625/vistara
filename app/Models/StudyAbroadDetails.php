...
class StudyAbroadDetails extends Model
{
    use CrudTrait;
    use HasFactory;
    ...
    */
    ...
    protected $table = 'country_abroad_details';
  ...
  public function setImageAttribute($value)
    {
        ...
        $destination_path = "study_abroad_details/";
    ...
    {
        return $this->belongsTo(StudyAbroad::class, 'study_abroads_id');
    }
    /*
    |--------------------------------------------------------------------------
    | ACCESSORS
