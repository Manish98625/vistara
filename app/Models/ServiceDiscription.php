...
class ServiceDiscription extends Model
{
    use CrudTrait;
    use HasFactory;
    ...
    */
        ...
        {
            return $this->belongsTo(\App\Models\Services::class, 'our_services_id');
        }
    /*
    |--------------------------------------------------------------------------
    | RELATIONS
    ...
    */
    public function setImageAttribute($value)
    {
        ...
        $destination_path = "servicesdiscp/";
