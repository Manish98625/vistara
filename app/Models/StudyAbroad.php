...
use App\Models\StudyAbroadDetail;
...
class StudyAbroad extends Model
{
    ...
    */
      public function setImageAttribute($value)
    {
        ...
        $destination_path = "study_abroads/";
    ...
    public static function boot()
    {
     ...
     public function StudyAbroadDetails()
    {
        return $this->hasMany(StudyAbroadDetails::class, 'study_abroads_id');
    }

     public function universities()
    {
        return $this->hasMany(University::class, 'study_abroads_id');
    }
