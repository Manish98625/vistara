...
<meta name="description" content="{{ $page_description ?? backpack_theme_config('meta_description') }}">
<meta name="keywords" content="{{ $page_keywords ?? backpack_theme_config('meta_keywords') }}">
